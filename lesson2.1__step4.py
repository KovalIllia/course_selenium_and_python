...
try:
    ...
    input = browser.find_element(By.XPATH, "//img[@id='treasure']")
    ...
    input_checkbox = browser.find_element(By.XPATH, "//input[@id='robotCheckbox']")
    input_checkbox.click()
    input_radiobutton = browser.find_element(By.XPATH, "//input[@id='robotsRule']")
